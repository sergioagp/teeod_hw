...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/src/Ultra96_V2_constraints_190430.xdc"]"\
  ]
  foreach ifile $files {
...
set file "[file normalize "$origin_dir/src/Ultra96_V2_constraints_190430.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/Ultra96_V2_constraints_190430.xdc"
...
# Hierarchical cell: ITCM_0
proc create_hier_cell_ITCM_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_ITCM_0() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins S_AXI1] [get_bd_intf_pins axi_bram_ctrl_1/S_AXI]
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram_we_a [get_bd_pins axi_bram_ctrl_0/bram_we_a] [get_bd_pins xlslice_3/Din]
  ...
  connect_bd_net -net axi_bram_ctrl_1_bram_we_a [get_bd_pins axi_bram_ctrl_1/bram_we_a] [get_bd_pins xlslice_2/Din]
  ...
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins blk_mem_gen_0/web] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins blk_mem_gen_0/wea] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk]

  # Restore current instance
  current_bd_instance $oldCurInst
}
  
# Hierarchical cell: sh_mem_0
proc create_hier_cell_sh_mem_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_sh_mem_0() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_enclave_0 { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_enclave_0() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: ITCM_0
  create_hier_cell_ITCM_0 $hier_obj ITCM_0
  ...
  # Create instance: rst_enclave_0, and set properties
  set rst_enclave_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 rst_enclave_0 ]
  set_property -dict [list \
  ...
  set_property CONFIG.IN1_WIDTH {7} $xlconcat_0
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins rst_enclave_0/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins S_AXI1] [get_bd_intf_pins ITCM_0/S_AXI1]
  ...
  # Create instance: enclave_0
  create_hier_cell_enclave_0 [current_bd_instance .] enclave_0
  ...
  # Create instance: sh_mem_0
  create_hier_cell_sh_mem_0 [current_bd_instance .] sh_mem_0
...
\
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins enclave_0/M03_AXI] [get_bd_intf_pins sh_mem_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins sh_mem_0/S_AXI1]
  ...
  # Create port connections
  connect_bd_net -net enclave_0_peripheral_aresetn [get_bd_pins enclave_0/peripheral_aresetn] [get_bd_pins sh_mem_0/s_axi_aresetn] [get_bd_pins teeod_ipc_0/enclv_axi_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins enclave_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins teeod_ipc_0/tee_axi_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins enclave_0/HCLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins sh_mem_0/s_axi_aclk] [get_bd_pins teeod_ipc_0/enclv_axi_aclk] [get_bd_pins teeod_ipc_0/tee_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0xA0030000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs sh_mem_0/axi_bram_ctrl_1/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces enclave_0/CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs sh_mem_0/axi_bram_ctrl_0/S_AXI/Mem0] -force
